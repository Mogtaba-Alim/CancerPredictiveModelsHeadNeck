...
if __name__ == "__main__":
    df_outcomes = pd.read_csv(
        '/Users/maximus/Desktop/FALL2023/BCB430/code/headNeckModels/ClinicalData/RADCURE/RADCURE-DA-CLINICAL-2.csv')
    ...
    for nc in negative_controls:
        ...
        for md in model_type:
            ...
            df_results_path = "/Users/maximus/Desktop/FALL2023/BCB430/code/headNeckModels/CancerPredictiveModelsHeadNeck/Output/Radcure/" + nc + "/" + md
    ...
    output_results.to_csv('/Users/maximus/Desktop/FALL2023/BCB430/code/headNeckModels/CancerPredictiveModelsHeadNeck/Output/Radcure/Radcure_metrics_output.csv', index=False)
